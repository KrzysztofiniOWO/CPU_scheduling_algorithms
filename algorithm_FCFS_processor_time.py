class algorithm_FCFS:

    def __init__(self):
        """Initialize class"""

    def przydzial_czasu_FCFS(self, numer):
    ...
    def load_times(self, number):
        """Load data of arrival times and burst time from data file"""
    ...
    def save_waiting_and_turn_around_times(self, calculations, number):
        ...
        with open(f"FCFS_results/{number}.txt", "w") as f:
